...
## Cloud-Init-Config Validation und Debugging

Cloud-init ist in der Lage, Cloud-Config-Benutzerdaten direkt aus seiner Datenquelle zu validieren (d. h. auf einer laufenden Cloud-Instanz). Um dies zu tun, können Sie ausführen:

`sudo cloud-init schema --system --annotate`

Oder, um YAML in einer bestimmten Datei zu testen:

`cloud-init schema -c test.yml --annotate`

Zuerst noch yaml file verschieben:

`multipass transfer test.yml  VMNAME:/home/ubuntu/test.yml`
